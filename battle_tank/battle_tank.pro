...
unrealRootPath=/home/brian/Programs/UnrealEngine
battle_tankRootPath=/home/brian/Documents/Programming/games/battle_tank/battle_tank

gameProjectFile=/home/brian/Documents/Programming/games/battle_tank/battle_tank/battle_tank.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(battle_tankSource.pri)
include(battle_tankHeader.pri)
include(battle_tankConfig.pri)
include(battle_tankIncludes.pri)
include(battle_tankDefines.pri)
...
battle_tank-Linux-Debug.commands = $$build battle_tank Linux Debug  -project="\"$$gameProjectFile\"" $$args
battle_tank-Linux-DebugGame.commands = $$build battle_tank Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
battle_tank-Linux-Shipping.commands = $$build battle_tank Linux Shipping  -project="\"$$gameProjectFile\"" $$args
battle_tank-Linux-Test.commands = $$build battle_tank Linux Test  -project="\"$$gameProjectFile\"" $$args
battle_tank.commands = $$build battle_tank Linux Development  -project="\"$$gameProjectFile\"" $$args

battle_tankEditor-Linux-Debug.commands = $$build battle_tankEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
battle_tankEditor-Linux-DebugGame.commands = $$build battle_tankEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
battle_tankEditor-Linux-Shipping.commands = $$build battle_tankEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
battle_tankEditor-Linux-Test.commands = $$build battle_tankEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
battle_tankEditor.commands = $$build battle_tankEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	battle_tank-Linux-Debug \
	battle_tank-Linux-DebugGame \
	battle_tank-Linux-Shipping \
	battle_tank-Linux-Test \
	battle_tank \
	battle_tankEditor-Linux-Debug \
	battle_tankEditor-Linux-DebugGame \
	battle_tankEditor-Linux-Shipping \
	battle_tankEditor-Linux-Test \
	battle_tankEditor \
